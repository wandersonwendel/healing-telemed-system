...
#Criptografar dados
SECRET_KEY = 'django-insecure-rps*f1cs53@jm%o=-te)_rfnc9&1gj$xvj#(x+m&qzg(vbg8ec'

# SECURITY WARNING: don't run with debug turned on in production!
# Quando a aplicação ainda está em desenvolvimento (True)
DEBUG = True

# Quais os domínios que podem acessar esta aplicação (Healing)
ALLOWED_HOSTS = []
