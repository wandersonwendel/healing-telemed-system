...
def abrir_horario(request):
    ...
    if request.method == "GET":
        ...
        if data_formatada <= datetime.now():
            messages.add_message(request, constants.WARNING, 'A data dev ser maior ou igual a data atual!')
            return redirect('/medicos/abrir_horario')
        ...
        messages.add_message(request, constants.SUCESS, 'Horário cadastrado com sucesso!')
        return redirect('/medicos/abrir_horario')
